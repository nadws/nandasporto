export const projectData = [
  {
    ...
    title: "Alquran App",
    description:
      "A simple Al-Qur’an Web App built with JavaScript. It allows users to read the Qur’an directly from the browser with a clean and minimal interface. All surahs and ayahs are stored locally, making it fast and accessible without internet once loaded.",
    gitHubLink: "https://alquran-nadws.vercel.app/",
  },
  {
    id: 2,
